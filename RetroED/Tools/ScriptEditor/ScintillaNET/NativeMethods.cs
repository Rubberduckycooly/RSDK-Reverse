...
namespace ScintillaNET
{
    internal static class NativeMethods
    {
        ...
        public const int SCLEX_PSDK = 121;
        ...
        // PSDK
        public const int SCE_PSDK_DEFAULT = 0;
        public const int SCE_PSDK_COMMENT = 1;
        public const int SCE_PSDK_COMMENTLINE = 2;
        public const int SCE_PSDK_COMMENTDOC = 3;
        public const int SCE_PSDK_NUMBER = 4;
        public const int SCE_PSDK_WORD = 5;
        public const int SCE_PSDK_STRING = 6;
        public const int SCE_PSDK_CHARACTER = 7;
        public const int SCE_PSDK_UUID = 8;
        public const int SCE_PSDK_PREPROCESSOR = 9;
        public const int SCE_PSDK_OPERATOR = 10;
        public const int SCE_PSDK_IDENTIFIER = 11;
        public const int SCE_PSDK_STRINGEOL = 12;
        public const int SCE_PSDK_VERBATIM = 13;
        public const int SCE_PSDK_REGEX = 14;
        public const int SCE_PSDK_COMMENTLINEDOC = 15;
        public const int SCE_PSDK_WORD2 = 16;
        public const int SCE_PSDK_COMMENTDOCKEYWORD = 17;
        public const int SCE_PSDK_COMMENTDOCKEYWORDERROR = 18;
        public const int SCE_PSDK_GLOBALCLASS = 19;
        public const int SCE_PSDK_STRINGRAW = 20;
        public const int SCE_PSDK_TRIPLEVERBATIM = 21;
        public const int SCE_PSDK_HASHQUOTEDSTRING = 22;
        public const int SCE_PSDK_PREPROCESSORCOMMENT = 23;
        public const int SCE_PSDK_PREPROCESSORCOMMENTDOC = 24;
        public const int SCE_PSDK_USERLITERAL = 25;
        public const int SCE_PSDK_TASKMARKER = 26;
        public const int SCE_PSDK_ESCAPESEQUENCE = 27;
        public const int SCE_PSDK_ENGINECALLBACK = 28;
        public const int SCE_PSDK_ENGINEFUNCTION = 29;
