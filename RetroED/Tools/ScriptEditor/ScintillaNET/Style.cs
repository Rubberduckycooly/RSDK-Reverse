...
namespace ScintillaNET
{
    ...
    public class Style
    {
        ...
        /// <summary>
        /// Style constants for use with the <see cref="Lexer.PSDK" /> lexer.
        /// </summary>
        public static class PSDK
        {
            /// <summary>
            /// Default (whitespace) style index.
            /// </summary>
            public const int Default = NativeMethods.SCE_PSDK_DEFAULT;

            /// <summary>
            /// Comment style index.
            /// </summary>
            public const int Comment = NativeMethods.SCE_PSDK_COMMENT;

            /// <summary>
            /// Line comment style index.
            /// </summary>
            public const int CommentLine = NativeMethods.SCE_PSDK_COMMENTLINE;

            /// <summary>
            /// Documentation comment style index.
            /// </summary>
            public const int CommentDoc = NativeMethods.SCE_PSDK_COMMENTDOC;

            /// <summary>
            /// Number style index.
            /// </summary>
            public const int Number = NativeMethods.SCE_PSDK_NUMBER;

            /// <summary>
            /// Keyword style index.
            /// </summary>
            public const int Word = NativeMethods.SCE_PSDK_WORD;

            /// <summary>
            /// Double-quoted string style index.
            /// </summary>
            public const int String = NativeMethods.SCE_PSDK_STRING;

            /// <summary>
            /// Single-quoted string style index.
            /// </summary>
            public const int Character = NativeMethods.SCE_PSDK_CHARACTER;

            /// <summary>
            /// UUID style index.
            /// </summary>
            public const int Uuid = NativeMethods.SCE_PSDK_UUID;

            /// <summary>
            /// Preprocessor style index.
            /// </summary>
            public const int Preprocessor = NativeMethods.SCE_PSDK_PREPROCESSOR;

            /// <summary>
            /// Operator style index.
            /// </summary>
            public const int Operator = NativeMethods.SCE_PSDK_OPERATOR;

            /// <summary>
            /// Identifier style index.
            /// </summary>
            public const int Identifier = NativeMethods.SCE_PSDK_IDENTIFIER;

            /// <summary>
            /// Unclosed string EOL style index.
            /// </summary>
            public const int StringEol = NativeMethods.SCE_PSDK_STRINGEOL;

            /// <summary>
            /// Verbatim string style index.
            /// </summary>
            public const int Verbatim = NativeMethods.SCE_PSDK_VERBATIM;

            /// <summary>
            /// Regular expression style index.
            /// </summary>
            public const int Regex = NativeMethods.SCE_PSDK_REGEX;

            /// <summary>
            /// Documentation comment line style index.
            /// </summary>
            public const int CommentLineDoc = NativeMethods.SCE_PSDK_COMMENTLINEDOC;

            /// <summary>
            /// Keyword style 2 index.
            /// </summary>
            public const int Word2 = NativeMethods.SCE_PSDK_WORD2;

            /// <summary>
            /// Comment keyword style index.
            /// </summary>
            public const int CommentDocKeyword = NativeMethods.SCE_PSDK_COMMENTDOCKEYWORD;

            /// <summary>
            /// Comment keyword error style index.
            /// </summary>
            public const int CommentDocKeywordError = NativeMethods.SCE_PSDK_COMMENTDOCKEYWORDERROR;

            /// <summary>
            /// Global class style index.
            /// </summary>
            public const int GlobalClass = NativeMethods.SCE_PSDK_GLOBALCLASS;

            /// <summary>
            /// Raw string style index.
            /// </summary>
            public const int StringRaw = NativeMethods.SCE_PSDK_STRINGRAW;

            /// <summary>
            /// Triple-quoted string style index.
            /// </summary>
            public const int TripleVerbatim = NativeMethods.SCE_PSDK_TRIPLEVERBATIM;

            /// <summary>
            /// Hash-quoted string style index.
            /// </summary>
            public const int HashQuotedString = NativeMethods.SCE_PSDK_HASHQUOTEDSTRING;

            /// <summary>
            /// Preprocessor comment style index.
            /// </summary>
            public const int PreprocessorComment = NativeMethods.SCE_PSDK_PREPROCESSORCOMMENT;

            /// <summary>
            /// Preprocessor documentation comment style index.
            /// </summary>
            public const int PreprocessorCommentDoc = NativeMethods.SCE_PSDK_PREPROCESSORCOMMENTDOC;

            /// <summary>
            /// User-defined literal style index.
            /// </summary>
            public const int UserLiteral = NativeMethods.SCE_PSDK_USERLITERAL;

            /// <summary>
            /// Task marker style index.
            /// </summary>
            public const int TaskMarker = NativeMethods.SCE_PSDK_TASKMARKER;

            /// <summary>
            /// Escape sequence style index.
            /// </summary>
            public const int EscapeSequence = NativeMethods.SCE_PSDK_ESCAPESEQUENCE;

            /// <summary>
            /// Escape sequence style index.
            /// </summary>
            public const int EngineCallBack = NativeMethods.SCE_PSDK_ENGINECALLBACK;

            /// <summary>
            /// Escape sequence style index.
            /// </summary>
            public const int EngineFunction = NativeMethods.SCE_PSDK_ENGINEFUNCTION;
        }
