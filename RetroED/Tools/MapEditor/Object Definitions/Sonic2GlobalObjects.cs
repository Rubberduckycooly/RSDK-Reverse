...
{
    public class Sonic2Objects
    {
        MapObject Blank = new MapObject("Blank Object", 0, 0, "Blank Objects Don't Need Sprites Lmao",0,0,0,0);

        MapObject Player = new MapObject("Player Spawn", 1, 0, "Sprites/Players/Sonic1.gif", 1, 1, 27, 40);
        ...
        public Sonic2Objects()
        {
            ...
            Objects.Add(new Point(VSGame.ID, VSGame.SubType), VSGame);
            Objects.Add(new Point(NextStageTrigger.ID, NextStageTrigger.SubType), NextStageTrigger);
            Objects.Add(new Point(InvisibleBlock.ID, InvisibleBlock.SubType), InvisibleBlock);
            Objects.Add(new Point(SpringBoard.ID, SpringBoard.SubType), SpringBoard);
        }
